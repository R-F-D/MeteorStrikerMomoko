...
var cc;
var rc,L,C;
var Sprite,Store,Label,Achievement,Achievements,sound,Effect,Button;
...
Scene.Title	= class extends Scene.SceneBase {
	...
	InitUIs(){
		...
		this.buttons.at("Play")
			...
			.OnButtonUp(()=>this.ReplaceScene(Scene.Transition,true).SetTransitionTo(Scene.GamePlay,true))
